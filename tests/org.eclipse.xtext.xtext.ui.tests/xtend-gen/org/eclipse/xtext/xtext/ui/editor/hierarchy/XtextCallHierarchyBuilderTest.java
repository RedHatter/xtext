...
public class XtextCallHierarchyBuilderTest extends AbstractHierarchyBuilderTest {
  ...
  protected String internalToExpectation(final HierarchyNode node, final HierarchyBuilder builder, final HierarchyContext context) {
    final String superExpectation = super.internalToExpectation(node, builder, context);
  ...
  protected String internalToExpectation(final XtextCallHierarchyNode node, final HierarchyBuilder builder, final HierarchyContext context) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("\t\t");
    _builder.newLine();
    return _builder.toString();
