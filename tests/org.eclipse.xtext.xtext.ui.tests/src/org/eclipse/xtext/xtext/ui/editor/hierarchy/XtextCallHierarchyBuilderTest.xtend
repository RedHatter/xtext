...
class XtextCallHierarchyBuilderTest extends AbstractHierarchyBuilderTest {
	...
	override protected internalToExpectation(HierarchyNode node, HierarchyBuilder builder, HierarchyContext context) {
		val superExpectation = super.internalToExpectation(node, builder, context)
