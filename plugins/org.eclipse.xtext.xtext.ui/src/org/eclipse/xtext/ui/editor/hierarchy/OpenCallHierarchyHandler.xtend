...
class OpenCallHierarchyHandler extends AbstractOpenHierarchyHandler {
	...
	public static val CALL_HIERARCHY_VIEW_PART_ID = 'org.eclipse.xtext.ui.XtextCallHierarchy'
	...
	override protected getHierarchyViewPartID() {
		CALL_HIERARCHY_VIEW_PART_ID
	}

	override protected createHierarchyContext(EObject target) {
