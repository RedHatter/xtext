...
public abstract class AbstractHierarchyViewPart extends ViewPart {
  ...
  protected HierarchyRoot createRoot(final IProgressMonitor monitor) {
    if ((((this.context == null) || (this.builder == null)) || (this.rootURI == null))) {
      return HierarchyRoot.EMPTY;
    }
    final Collection<HierarchyNode> roots = this.builder.buildRoots(this.rootURI, this.context, monitor);
  ...
  @Pure
  protected HierarchyContext getContext() {
    return this.context;
  }
  
  public void setContext(final HierarchyContext context) {
