...
public abstract class AbstractOpenHierarchyHandler extends AbstractHandler {
  ...
  protected void openHierarchy(final EObject target, final IWorkbenchWindow workbenchWindow) {
    try {
      ...
      if ((viewPart instanceof AbstractHierarchyViewPart)) {
        HierarchyContext _createHierarchyContext = this.createHierarchyContext(target);
        ((AbstractHierarchyViewPart)viewPart).setContext(_createHierarchyContext);
  ...
  protected abstract HierarchyContext createHierarchyContext(final EObject target);
